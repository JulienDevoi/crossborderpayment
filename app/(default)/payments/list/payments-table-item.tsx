...
import { Transaction } from './payments-table'
...
export default function PaymentsTableItem({ transaction, onCheckboxChange, isSelected }: PaymentsTableItemProps) {
  ...
  return (
    <tr className="cursor-pointer hover:bg-gray-50 dark:hover:bg-gray-800/50" onClick={handleTransactionClick}>
      <td className="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap w-px" onClick={(e) => e.stopPropagation()}>
