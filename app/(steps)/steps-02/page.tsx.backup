...
export default function Steps01() {
  return (
            ...
            <div className="max-w-md mx-auto">
              ...
              <form>
                ...
                <div className="flex items-center justify-between">
                  <Link className="btn bg-gray-900 text-gray-100 hover:bg-gray-800 dark:bg-gray-100 dark:text-gray-800 dark:hover:bg-white ml-auto" href="/steps-02">Next Step →</Link>
                </div>
              </form>
