    ...
    <div className="relative bg-white dark:bg-gray-900 h-full">
      ...
      <div className="sm:flex sm:justify-between sm:items-center px-4 sm:px-6 py-8 border-b border-gray-200 dark:border-gray-700/60">
        ...
        <div className="mb-4 sm:mb-0">
          <h1 className="text-2xl md:text-3xl text-gray-800 dark:text-gray-100 font-bold">Payment History</h1>
        </div>
        ...
        <div className="grid grid-flow-col sm:auto-cols-max justify-start sm:justify-end gap-2">
          ...
          {/* Add event button */}
          <button className="btn bg-gray-900 text-gray-100 hover:bg-gray-800 dark:bg-gray-100 dark:text-gray-800 dark:hover:bg-white">Make Payment</button>
      ...
      <div className="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-[96rem] mx-auto">
        <div className="max-w-2xl m-auto mt-16">
          ...
          <div className="text-center px-4">
            ...
            <h2 className="text-2xl text-gray-800 dark:text-gray-100 font-bold mb-2">No payment history yet</h2>
            <div className="mb-6">You haven't made any payments yet. Once you start processing payments, your transaction history will appear here with detailed records of all your financial activities.</div>
            <button className="btn bg-gray-900 text-gray-100 hover:bg-gray-800 dark:bg-gray-100 dark:text-gray-800 dark:hover:bg-white">Make Payment</button>
          </div>
