          ...
          <DialogPanel className="bg-white dark:bg-gray-800 border border-transparent dark:border-gray-700/60 overflow-auto max-w-2xl w-full max-h-full rounded-lg shadow-lg">
            ...
            <form className="border-b border-gray-200 dark:border-gray-700/60">
              <div className="relative">
                ...
                <input id="search-modal" className="w-full dark:text-gray-300 bg-white dark:bg-gray-800 border-0 focus:ring-transparent placeholder-gray-400 dark:placeholder-gray-500 appearance-none py-3 pl-10 pr-4" type="search" placeholder="Search payments, transactions, settings…" />
                ...
                <ul className="text-sm">
                  <li>
                    ...
                    >
                      ...
                      <span>Payment Gateway Integration Guide</span>
                    </Link>
                  </li>
                  <li>
                    <Link
                    ...
                    >
                      ...
                      <span>Mobile Payment Processing Setup</span>
                    </Link>
                  </li>
                  <li>
                    <Link
                    ...
                    >
                      ...
                      <span>Payment Security Updates - Q4 2024</span>
                    </Link>
                  </li>
                  <li>
                    <Link
                    ...
                    >
                      ...
                      <span>Transaction Fee Calculator</span>
                    </Link>
                  </li>
                  <li>
                    <Link
                ...
                <ul className="text-sm">
                  <li>
                    ...
                    >
                      ...
                      <span><span className="font-medium">Payments</span> - <span className="text-gray-600 dark:text-gray-400">Transaction History / … / Payment #12345</span></span>
                    </Link>
                  </li>
                  <li>
                    <Link
                    ...
                    >
                      ...
                      <span><span className="font-medium">Settings</span> - <span className="text-gray-600 dark:text-gray-400">Payment Configuration / … / Gateway Settings</span></span>
                    </Link>
                  </li>
                </ul>
              </div>
